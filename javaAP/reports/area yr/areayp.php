...
for ($x = 0; $x <$i; $x++) {    
    ...
    $sql1 = "SELECT * FROM report WHERE P_ID ='$p[$x]' and Year ='$yt' and Area = '$ar' " ; 
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	theme: "light2",
	title:{
		text: "Annually Area Wise Sales Report"
	},
	axisY:{
		includeZero: true
...
for ($x = 0; $x <$i; $x++) {    
    ...
    $sql1 = "SELECT * FROM report WHERE P_ID ='$p[$x]' and Year ='2021'and Area = '$ar' " ; 
