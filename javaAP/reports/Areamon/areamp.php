...
for ($x = 0; $x <$i; $x++) {    
    ...
    $sql1 = "SELECT * FROM report WHERE P_ID ='$p[$x]' and Month ='$mon'and Year ='$yt' and Area = '$ar' " ; 
...
var chart = new CanvasJS.Chart("chartContainer", {
	...
	theme: "light2",
	title:{
		text: "Monthly Area Wise Sales Report"
	},
	axisY:{
		includeZero: true
...
if ($conn->connect_error) {
  die("Connection failed: " . $conn->connect_error);
     ...
     $ar=$_POST['area'];
     $yt = (int)$yr;
  echo "<h4>Month - ", $mon ,"        Year - ",$yr, "<h4>";    
    $sql2 = "SELECT * FROM area WHERE A_ID = '$ar'";
...
if ($result->num_rows > 0) {
 // echo "<table style='border: solid 1px black;'><tr><th>ID</th><th>No Of Items</th><th>No Of Packed Samples</th><th>Date</th></tr><caption>Stock Details</caption>";
  ...
  echo "<h3>Area  - ", $ar ,"( ",$areas, " )<br></h3>";  
    
    
  $sql3 = "SELECT * FROM employee WHERE E_ID = '$eid'";
...
echo "<h3>Representative ID : ",$eid,"<br> Name :", $name ,"<br> E-Mail : ",$email , "<br>"; 
...
for ($x = 0; $x <$i; $x++) {    
    ...
    $sql1 = "SELECT * FROM report WHERE P_ID ='$p[$x]' and Month ='January'and Year ='2021'and Area = '$ar' " ; 
  ...
  echo  "<p><br>Total Dispatched Value : ",$disT,"<br>Total Invoiced Value : ",$inoT,"<br>Total Returned Value : ",$reT;
   for($j=0;$j<$i;$j++){
      
        echo " <br><h3>Product ID :",$p[$j]," </h3><br>Dispatched Value : ",$disV[$j]," <br>Sales Value : ",$inoV[$j], " <br>Returned Value : ",$reV[$j] ;
   } 
    //$p[]
$conn->close();
